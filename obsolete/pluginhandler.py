...
def getPlugins(uid):
	"""Get the list of plugins assigned to this uid.
	
	Returns an iterable object.  If there is no plugin assigned to this uid, a
	ValueError is raised. It is the ai module's responsibility to load the
	default plugins.
...
def removePlugin(uid, pluginID):
	"""Remove this plugin from this uid.
	
	Raises a ValueError if this pluginID is not assigned to this uid.
...
#TODO: quick and dirty fix; need more elegant solution.
